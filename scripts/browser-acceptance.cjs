...
await page.evaluate(async()=>{const M=await import('/src/model.js'),s=JSON.parse(localStorage.getItem('pirate-clashers-v1'));s.battle.enemy.hull=20;s.battle.rng=1;localStorage.setItem('pirate-clashers-v1',JSON.stringify(s))});
